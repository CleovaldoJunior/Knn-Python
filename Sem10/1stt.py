...
class Neural_Network:
    ...
    def BackPropogation(self):
        ...
        d_weights1 = -(1 / m) * np.dot(self.input.T, (
               np.dot((self.y - self.output) * sigmoid_derivative(self.output), self.weights2.T) * ReLU_derivative(self.layer1)))
...
n=len(X_test)
m=len(X)
nn1=Neural_Network(X_train,Y_train,10)
#creating an object of Neural_Network class
#----------------------Training Starts-----------------------------#
