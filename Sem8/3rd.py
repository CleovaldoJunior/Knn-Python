...
coluna = ['1', '2', '3', '4','5','6','7','8','9','classe']
cancer = pd.read_csv('breast-cancer.data', names=coluna)
scale = numerico(cancer)

X = cancer.drop(['classe'], axis=1)
y = cancer.classe.astype('int')
